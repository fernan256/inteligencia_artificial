...
if __name__ == "__main__":
    ...
    while iterations < max_iter:
        for i in range(len(inputs)):
            ...
            splited_weights, output_weigths, error, real_output, all_time_weights_h, all_time_weights_o = back_propagation_calculation(inputs[i][1], inputs[i][0], splited_weights, output_layer, output_weigths, output_activation_res, lerning_rate, all_time_weights_h, all_time_weights_o)
